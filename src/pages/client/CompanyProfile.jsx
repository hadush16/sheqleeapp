  ...
  useEffect(() => {
    const fetchCompany = async () => {
      try {
        ...
        const myCompany = res.data.data.companies.find(
          (company) => company.owner?._id === user?._id,
        );
        ...
        setForm({
          ...
          domain: myCompany.domain
            ? myCompany.domain.replace(/^https?:\/\//, "")
            : "",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-[38px]">
            ...
            <div>
              ...
              <div className="mt-2 flex items-center bg-[#DFDFDF] rounded-lg overflow-hidden px-[23px] py-[18px]">
                ...
                >
                  <option value="Less than 10 people">
                    Less than 10 people
                  </option>
